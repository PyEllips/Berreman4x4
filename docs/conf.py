...
module_dir = os.path.join(__location__, "../src/elli")
try:
...
try:
    from elli import __version__ as version
except ImportError:
    version = ""
...
latex_documents = [
    ("index", "user_guide.tex", "pyElli Documentation", "dobener", "manual")
]
